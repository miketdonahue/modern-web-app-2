...
export const typeDefs = /* GraphQL */ `
  ...
  type Mutation {
    ...
    createOpenAuth(data: OpenAuthCreateInput!): OpenAuth!
    updateOpenAuth(
  ...
  type OpenAuthConnection {
    pageInfo: PageInfo!
    edges: [OpenAuthEdge]!
    aggregate: AggregateOpenAuth!
  }

  input OpenAuthCreateInput {
    id: ID
  ...
  type OpenAuthSubscriptionPayload {
    mutation: MutationType!
    node: OpenAuth
    updatedFields: [String!]
  ...
  input OpenAuthSubscriptionWhereInput {
    mutation_in: [MutationType!]
    updatedFields_contains: String
    updatedFields_contains_every: [String!]
    updatedFields_contains_some: [String!]
    node: OpenAuthWhereInput
    AND: [OpenAuthSubscriptionWhereInput!]
    OR: [OpenAuthSubscriptionWhereInput!]
    NOT: [OpenAuthSubscriptionWhereInput!]
  }

  input OpenAuthUpdateInput {
  ...
  input OpenAuthUpdateManyMutationInput {
    provider: ProviderName
    accessToken: String
    refreshToken: String
    expiresAt: DateTime
  ...
  input OpenAuthWhereInput {
    ...
    user: UserWhereInput
    provider: ProviderName
    provider_not: ProviderName
    provider_in: [ProviderName!]
    provider_not_in: [ProviderName!]
    accessToken: String
    ...
    deletedAt_gt: DateTime
    deletedAt_gte: DateTime
    AND: [OpenAuthWhereInput!]
    OR: [OpenAuthWhereInput!]
    NOT: [OpenAuthWhereInput!]
  }

  input OpenAuthWhereUniqueInput {
    id: ID
  }
  ...
  type Query {
    ...
    openAuth(where: OpenAuthWhereUniqueInput!): OpenAuth
    openAuths(
      where: OpenAuthWhereInput
