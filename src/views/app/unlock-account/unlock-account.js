...
var unlock_account_module_scss_1 = require("./unlock-account.module.scss");
var UnlockAccount = function () {
    ...
    var formik = formik_1.useFormik({
        ...
        validationSchema: validations_1.unlockAccountValidationSchema,
    ...
    return (<div className={unlock_account_module_scss_1["default"].grid}>
      <div className={unlock_account_module_scss_1["default"].gridLeft}>
        <div className={unlock_account_module_scss_1["default"].unlockAccountGrid}>
          <div className="py-6">
            <svg width="12rem" height="12rem" className="mx-auto" viewBox="0 0 180 180" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M64.4476 82.1526V47.4734C64.4476 33.6674 75.7882 22.3268 89.5942 22.3268C103.4 22.3268 114.741 33.6674 114.741 47.4734V50L127.232 47.4734C127.232 26.7644 110.467 10 89.7585 10C69.0496 10 52.2852 26.7644 52.2852 47.4734V82.1526H64.4476Z" fill="#2B3B4E"/>
              <path d="M136.271 156.606H42.9168C39.6297 156.606 37 153.977 37 150.689V84.7823C37 81.4952 39.6297 78.8655 42.9168 78.8655H136.271C139.559 78.8655 142.188 81.4952 142.188 84.7823V150.689C142.188 153.977 139.559 156.606 136.271 156.606Z" fill="#ECB85E"/>
              <path d="M89.5942 99.0813C83.8417 99.0813 79.2397 103.683 79.2397 109.436C79.2397 113.38 81.5407 116.832 84.6635 118.475V131.624C84.6635 134.254 86.8001 136.39 89.4298 136.39C92.0596 136.39 94.1962 134.254 94.1962 131.624V118.475C97.4833 116.667 99.62 113.38 99.62 109.436C99.9487 103.683 95.3467 99.0813 89.5942 99.0813Z" fill="#324A5E"/>
            </svg>
      ...
      <div className={unlock_account_module_scss_1["default"].gridRight}>
